    ...
    return BlocConsumer<AppCubit, AppState>(
        listener: (context, state) {
          if(state is AddOrdarSuccessState){
            myToast(mas: state.s.toString(), color:state.state? Colors.green:Colors.red);
            if(state.state){
                    ...
                    children: [
                      Row(children: [
                        ...
                        Padding(
                          ...
                          child: Text('Ordar Naw',style: TextStyle(color: defColor),),
                        ),
                        Expanded(child: Container(color: defColor,height: 1,)),
                      ],),
                      Stepper(
                        ...
                        controlsBuilder: (context,ControlsDetails controlsDetails)=>Container(margin: EdgeInsets.only(top: 20),
                          child: Row(children: [
                            Expanded(child: ElevatedButton(
                              onPressed: (){
                                controlsDetails.onStepContinue!.call();
                              },
                              child: Text(c.currentStep!=1?'Continue':'Confirm'),
                            )),
                            SizedBox(width: 10,),
                            if(c.currentStep!=1)
                              Expanded(child: ElevatedButton(
                            ...
                            content: Column(
                              children: [
                                InkWell(
                                  ...
                                  child: Row(
                                    children: [
                                      Text('Add New Address',style: TextStyle(color: defColor),),
                                ...
                                ListView.separated(
                                    ...
                                    itemBuilder: (context, index) => InkWell(
                                      ...
                                      onTap: (){
                                        ...
                                        print({c.getAddressModel!.addressData!.address[index].id});
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color:index==c.currentSelected?Colors.indigo[200]: Colors.white,
